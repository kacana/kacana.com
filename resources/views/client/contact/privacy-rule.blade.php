<h3 class="text-center color-grey">CHÍNH SÁCH BẢO MẬT</h3>
    ...
    <div class="col-md-12">
        <div>
            <div class="content_container">
                <p> Cám ơn quý khách đã truy cập vào website Kacana.com được vận hành bởi công ty TNHH MTV KACANA. Chúng tôi tôn trọng và cam kết sẽ bảo mật những thông tin mang tính riêng tư của bạn. Xin vui lòng đọc bản Chính sách bảo mật dưới đây để hiểu hơn những cam kết mà chúng tôi thực hiện nhằm tôn trọng và bảo vệ quyền lợi của người truy cập.</p>
                ...
                <p> Chúng tôi sẽ giữ thông tin của khách hàng trong thời gian luật pháp quy định hoặc cho mục đích nào đó.
                    Quý khách có thể truy cập vào website và trình duyệt mà không cần phải cung cấp chi tiết cá nhân. Lúc đó, bạn đang ẩn danh và chúng tôi không thể biết bạn là ai nếu bạn không đăng nhập vào tài khoản của mình.</p>
                ...
                <h5> Điều lệ khác về thông tin cá nhân</h5>
                ...
                <h5> Đối tác thứ ba và Liên kết</h5>
                ...
                <p>Với tính năng cài đặt&nbsp;<a href="https://www.google.com/settings/ads" target="_blank">quảng cáo</a>, người dùng hoặc khác hàng có thể lựa chọn thoát ra khỏi tính năng theo dõi hành vi khách hàng của Google Analytics và lựa chọn cách xuất hiện của kênh Hiển Thị Quảng Cáo trên Google<u></u><u></u></p>

                <p>Kacana và các nhà cung cấp bên thứ ba, bao gồm Google, có thể sử dụng cookies của Google Analytics hoặc cookies của bên thứ ba (như DoubleClick) để thu thập thông tin, tối ưu hóa và phục vụ cho mục đích quảng cáo dựa trên lần truy cập website của người dùng trong quá khứ.</p>
                ...
                <p>Quý khách có quyền yêu cầu truy cập vào dữ liệu cá nhân của mình, có quyền yêu cầu chúng tôi sửa lại những sai sót trong dữ liệu của bạn mà không mất phí. Bất cứ lúc nào bạn cũng có quyền yêu cầu chúng tôi ngưng sử dụng dữ liệu cá nhân của bạn cho mục đích tiếp thị.
                </p>
            </div>
            <br>
