...
class TagController extends BaseController {
    ...
    public function index()
    {
        ...
        return view('kcner.tag.index', array('tagTypes'=>$tagTypes));
    }
    ...
    {
        return view('kcner.tag.form-create', array('parent_id' => $parent_id));
    }
    ...
    public function fullEditTag($domain, $id, Request $request){
        ...
        try{
            ...
            return view('kcner.tag.edit-tag', array('tag' => $tagService->getTagById($id, false), 'success' => $success));
    ...
    public function relation($domain, $typeId, Request $request){
        ...
        return view('kcner.tag.relation', array('message'=> $message, 'typeId' => $typeId, 'typeName'=>$typeName));
    }
