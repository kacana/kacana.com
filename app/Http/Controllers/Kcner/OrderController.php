...
class OrderController extends BaseController {
    ...
    public function index($domain){
        ...
        return view('kcner.order.index', $data);
    }
...
//            print_r($feeGhtk->fee);die;
            return view('kcner.order.edit', compact('order', 'buyer', 'user_address', 'cities', 'districts', 'wards', 'shippingServiceInfos', 'hubInfos', 'feeGhtk'));
        } catch (\Exception $e) {
            if($request->ajax())
            {
