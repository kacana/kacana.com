...
class ShippingController extends BaseController {
    ...
    public function index(){
        return view('kcner.shipping.index');
    }
    ...
    public function detail(Request $request){
        ...
        try {
            ...
            return view('kcner.shipping.detail', compact('ship', 'user_address', 'cities', 'districts'));
        } catch (\Exception $e) {
            // @codeCoverageIgnoreStart
            $return['error'] = $e->getMessage();
            $return['errorMsg'] = $e->getMessage();
    ...
    public function printOrder(Request $request){
        ...
        try {
            ...
            return view('kcner.shipping.print_order', compact('ship', 'user_address'));
        } catch (\Exception $e) {
            // @codeCoverageIgnoreStart
            $return['error'] = $e->getMessage();
            $return['errorMsg'] = $e->getMessage();
    ...
    public function printOrderStore(Request $request){
        ...
        try {
            ...
            return view('kcner.shipping.print_order_store', compact('order', 'user', 'user_address'));
        } catch (\Exception $e) {
            // @codeCoverageIgnoreStart
            $return['error'] = $e->getMessage();
            $return['errorMsg'] = $e->getMessage();
