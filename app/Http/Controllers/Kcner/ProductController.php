...
class ProductController extends BaseController {
	...
	{
        return view('kcner.product.index');
	}
    ...
    public function editProduct($domain, $id, Request $request)
    {
        ...
        try{
            ...
            return view('kcner.product.edit-product', $results);
    ...
    public function exProduct(Request $request)
    {
        ...
        return view('kcner.product.ex-product', ['user'=> $this->_user]);
    }
    ...
    public function imProduct(Request $request)
    {
        ...
        return view('kcner.product.im-product');
    }
    ...
    public function printBarcode($domain, $productId, $propertyId, Request $request){
        ...
        try {
            ...
            return view('kcner.product.print_barcode', ['product' => $product, 'property' => $property]);
        } catch (\Exception $e) {
            // @codeCoverageIgnoreStart
            $return['error'] = $e->getMessage();
            $return['errorMsg'] = $e->getMessage();
