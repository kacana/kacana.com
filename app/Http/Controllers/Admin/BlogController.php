...
class BlogController extends BaseController {
    ...
    public function index(){
        ...
        return view('admin.blog.index', array('tags'=>$tags));
    }
    ...
    public function relation($domain, $typeId, Request $request){
        ...
        return view('admin.blog.relation', array('message'=> $message, 'typeId' => $typeId, 'typeName'=>$typeName));
    }
    ...
    public function editPost($domain, $postId, Request $request){
        ...
        try {
            if($request->method() == 'POST')
            {
                ...
                $titleSeo = $request->input('title_seo', 0);
