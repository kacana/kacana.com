...
Route::group(['domain'=>KACANA_AUTH_KCNER_NAME.'.{nameDomain}','middleware' => 'auth'], function () {
    ...
    Route::any('/', 'Kcner\IndexController@index');
    Route::post('/index/reportChartUser',                   array('as'=>'index-report-chart-user',              'uses'=>'Kcner\IndexController@reportChartUser'));
    Route::post('/index/reportChartOrder',                  array('as'=>'index-report-chart-order',             'uses'=>'Kcner\IndexController@reportChartOrder'));
    Route::post('/index/reportChartProductLike',            array('as'=>'index-report-chart-product-like',      'uses'=>'Kcner\IndexController@reportChartProductLike'));
    Route::post('/index/reportChartProductView',            array('as'=>'index-report-chart-product-view',      'uses'=>'Kcner\IndexController@reportChartProductView'));
    Route::post('/index/reportChartTrackingSearch',         array('as'=>'index-report-chart-tracking-search',   'uses'=>'Kcner\IndexController@reportChartTrackingSearch'));
    Route::any('/index/reportDetailTableUser',              array('as'=>'reportDetailTableUser',                'uses'=>'Kcner\IndexController@reportDetailTableUser'));
    Route::any('/index/reportDetailTableOrder',             array('as'=>'reportDetailTableOrder',               'uses'=>'Kcner\IndexController@reportDetailTableOrder'));
    Route::any('/index/reportDetailTableProductLike',       array('as'=>'reportDetailTableProductLike',         'uses'=>'Kcner\IndexController@reportDetailTableProductLike'));
    Route::any('/index/reportDetailTableProductView',       array('as'=>'reportDetailTableProductView',         'uses'=>'Kcner\IndexController@reportDetailTableProductView'));
    Route::any('/index/reportDetailTableTrackingSearch',    array('as'=>'reportDetailTableTrackingSearch',      'uses'=>'Kcner\IndexController@reportDetailTableTrackingSearch'));
    Route::any('/index/reportChartUserTracking',            array('as'=>'reportChartUserTracking',              'uses'=>'Kcner\IndexController@reportChartUserTracking'));
    Route::any('/index/reportDetailTableUserTracking',      array('as'=>'reportDetailTableUserTracking',        'uses'=>'Kcner\IndexController@reportDetailTableUserTracking'));

    //product
    Route::any('/product',                                  array('as'=>'listProducts',                         'uses'=>'Kcner\ProductController@index'));
    Route::any('/product/generateProductTable',             array('as'=>'generateProductTable',                 'uses'=>'Kcner\ProductController@generateProductTable'));
    Route::any('/product/generateImportProductTable',       array('as'=>'generate.import.product.table',        'uses'=>'Kcner\ProductController@generateImportProductTable'));
    Route::any('/product/generateProductTagTable',          array('as'=>'generateProductTagTable',              'uses'=>'Kcner\ProductController@generateProductTagTable'));
    Route::any('/product/getProductTreeMenu',               array('as'=>'getProductTreeMenu',                   'uses'=>'Kcner\ProductController@getProductTreeMenu'));
    Route::any('/product/getProduct',                       array('as'=>'getProducts',                          'uses'=>'Kcner\ProductController@getProduct'));
    Route::any('/product/createProduct',                    array('as'=>'createProduct',                        'uses'=>'Kcner\ProductController@createProduct'));
    Route::any('/product/editProduct/{id}',                 array('as'=>'editProduct',                          'uses'=>'Kcner\ProductController@editProduct'));
    Route::any('/product/exProduct',                        array('as'=>'exProduct',                            'uses'=>'Kcner\ProductController@exProduct'));
    Route::any('/product/imProduct',                        array('as'=>'imProduct',                            'uses'=>'Kcner\ProductController@imProduct'));
    Route::any('/product/importProduct',                    array('as'=>'importProduct',                        'uses'=>'Kcner\ProductController@importProduct'));
    Route::any('/product/getProductInfoByPropertyId',       array('as'=>'getProductInfoByPropertyId',           'uses'=>'Kcner\ProductController@getProductInfoByPropertyId'));
    Route::get('/product/removeProduct/{id}',               array('as'=>'removeProduct',                        'uses'=>'Kcner\ProductController@removeProduct'));
    Route::any('/product/uploadImageDescription',           array('as'=>'uploadImageDescription',               'uses'=>'Kcner\ProductController@uploadImageDescription'));
    Route::any('/product/listTags/',                        array('as'=>'ProductTags',                          'uses'=>'Kcner\ProductController@listTags'));
    Route::get('/product/setStatus/{id}/{status}',          array('as'=>'setStatusProduct',                     'uses'=>'Kcner\ProductController@setStatus'));
    Route::post('/product/addProductImage',                 array('as'=>'addProductImage',                      'uses'=>'Kcner\ProductController@addProductImage'));
    Route::post('/product/updateProductImageType',          array('as'=>'updateProductImageType',               'uses'=>'Kcner\ProductController@updateProductImageType'));
    Route::post('/product/updateImage',                     array('as'=>'updateImage',                          'uses'=>'Kcner\ProductController@updateImage'));
    Route::post('/product/createBaseProduct',               array('as'=>'CreateBaseProduct',                    'uses'=>'Kcner\ProductController@createBaseProduct'));
    Route::post('/product/countSearchProductByTagId',       array('as'=>'countSearchProductByTagId',            'uses'=>'Kcner\ProductController@countSearchProductByTagId'));
    Route::post('/product/createCSVForRemarketing',         array('as'=>'createCSVForRemarketing',              'uses'=>'Kcner\ProductController@createCSVForRemarketing'));
    Route::post('/product/sortProductGallery',              array('as'=>'product.sort.product.gallery',         'uses'=>'Kcner\ProductController@sortProductGallery'));
    Route::post('/product/deleteProductProperty',           array('as'=>'product.delete.product.property',      'uses'=>'Kcner\ProductController@deleteProductProperty'));
    Route::post('/product/updateImportProduct',             array('as'=>'product.update.import.product',        'uses'=>'Kcner\ProductController@updateImportProduct'));
    Route::get('/product/printBarcode/{productId}/{propertyId}',           array('as'=>'product.print.barcode', 'uses'=>'Kcner\ProductController@printBarcode'));

    //branch
    Route::any('/product/branch',                           array('as'=>'listBranches',             'uses'=>'Kcner\BranchController@index'));
    Route::any('/branch/getBranch',                         array('as'=>'getBranches',              'uses'=>'Kcner\BranchController@getBranch'));
    Route::post('/branch/createBranch',                     array('as'=>'createBranch',             'uses'=>'Kcner\BranchController@createBranch'));
    Route::get('/branch/showEditFormBranch/{id}',           array('as'=>'showEditFormBranch',       'uses'=>'Kcner\BranchController@showEditFormBranch'));
    Route::post('/branch/editBranch',                       array('as'=>'editBranch',               'uses'=>'Kcner\BranchController@editBranch'));
    Route::get('/branch/setStatusBranch/{id}/{status}',     array('as'=>'setStatusBranch',          'uses'=>'Kcner\BranchController@setStatusBranch'));
    Route::get('/branch/removeBranch/{id}',                 array('as'=>'removeBranch',             'uses'=>'Kcner\BranchController@removeBranch'));

    //tag
    Route::any('/product/tag',                              array('as'=>'listTags',                 'uses'=>'Kcner\TagController@index'));
    Route::any('/tag/relation/{typeId}',                    array('as'=>'relationtag',              'uses'=>'Kcner\TagController@relation'));
    Route::any('/tag/getTreeTag',                           array('as'=>'getTreeTag',               'uses'=>'Kcner\TagController@getTreeTag'));
    Route::post('/tag/createTag',                           array('as'=>'createTag',                'uses'=>'Kcner\TagController@createTag'));
    Route::post('/tag/addTagToRoot',                        array('as'=>'addTagToRoot',             'uses'=>'Kcner\TagController@addTagToRoot'));
    Route::post('/tag/addTagToParent',                      array('as'=>'addTagToParent',           'uses'=>'Kcner\TagController@addTagToParent'));
    Route::post('/tag/editTag',                             array('as'=>'editTag',                  'uses'=>'Kcner\TagController@editTag'));
    Route::post('/tag/removeTagRelation',                   array('as'=>'removeTagRelation',        'uses'=>'Kcner\TagController@removeTagRelation'));
    Route::post('/tag/searchTagRelation',                   array('as'=>'searchTagRelation',        'uses'=>'Kcner\TagController@searchTagRelation'));
    Route::any('/tag/searchTagProduct',                     array('as'=>'tag_search_tag_product',   'uses'=>'Kcner\TagController@searchTagProduct'));
    Route::any('/tag/searchTag',                            array('as'=>'tag_search_tag',           'uses'=>'Kcner\TagController@searchTag'));
    Route::post('/tag/processTagMove',                      array('as'=>'processTagMove',           'uses'=>'Kcner\TagController@processTagMove'));
    Route::post('/tag/updateImage',                         array('as'=>'updateImage',              'uses'=>'Kcner\TagController@updateImage'));
    Route::get('/tag/generateTagTable',                     array('as'=>'generateTagTable',         'uses'=>'Kcner\TagController@generateTagTable'));
    Route::get('/tag/getTag',                               array('as'=>'tag-get-tag',              'uses'=>'Kcner\TagController@getTag'));
    Route::any('/tag/fullEditTag/{id}',                     array('as'=>'tag-full-edit-tag',        'uses'=>'Kcner\TagController@fullEditTag'));
    Route::any('/tag/getGroupTag',                          array('as'=>'tag-get-group-tag',        'uses'=>'Kcner\TagController@getGroupTag'));
    Route::post('/tag/changeTagStatusRelation',             array('as'=>'tag-change-status-relation-tag',        'uses'=>'Kcner\TagController@changeTagStatusRelation'));

    //user
    Route::any('/user',                                     array('as'=>'listUsers',                 'uses'=>'Kcner\UserController@index'));
    Route::any('/user/generateUserTable',                   array('as'=>'generateUserTable',         'uses'=>'Kcner\UserController@generateUserTable'));
    Route::any('/user/generateAddressReceiveByUserId/{id}',      array('as'=>'generateAddressReceiveByUserId',      'uses'=>'Kcner\UserController@generateAddressReceiveByUserId'));
    Route::any('/user/generateAllOrderDetailByUserTable/{id}',   array('as'=>'generateAllOrderDetailByUserTable',   'uses'=>'Kcner\UserController@generateAllOrderDetailByUserTable'));
    Route::post('/user/create',                             array('as'=>'createUser',                'uses'=>'Kcner\UserController@create'));
    Route::any('/user/edit/{pid}',                          array('as'=>'editUser',                  'uses'=>'Kcner\UserController@edit'));
    Route::get('/user/setStatus/{id}/{status}',             array('as'=>'setStatusUser',             'uses'=>'Kcner\UserController@setStatus'));
    Route::get('/user/remove/{id}',                         array('as'=>'removeUser',                'uses'=>'Kcner\UserController@destroy'));
    Route::get('/user/showCreateForm',                      array('as'=>'showCreateForm',            'uses'=>'Kcner\UserController@showCreateForm'));
    Route::get('/user/getUserAddress/{id}',                 array('as'=>'listUserAddress',           'uses'=>'Kcner\UserController@getUserAddress'));
    Route::get('/user/showFormEditUserAddress/{id}',        array('as'=>'showFormEditUserAddress',   'uses'=>'Kcner\UserController@showFormEditUserAddress'));
    Route::post('/user/editUserAddress',                    array('as'=>'editUserAddress',           'uses'=>'Kcner\UserController@editUserAddress'));
    Route::get('/user/showListWards/{id}',                  array('as'=>'showListWards',             'uses'=>'Kcner\UserController@showListWards'));
    Route::get('/user/get-tracking-message-info',           array('as'=>'getTrackingMessageInfo',    'uses'=>'Kcner\UserController@getTrackingMessageInfo'));
    Route::get('/user/generateUserTrackingHistoryTable',    array('as'=>'generateUserTrackingHistoryTable',        'uses'=>'Kcner\UserController@generateUserTrackingHistoryTable'));
    Route::get('/user/detailUserTracking',                  array('as'=>'detailUserTracking',        'uses'=>'Kcner\UserController@detailUserTracking'));

    //Info request
    Route::any('/advisory',                                  array('as'=>'index',                           'uses'=>'Kcner\AdvisoryController@index'));
    Route::any('/advisory/getAdvisory',                      array('as'=>'getAdvisory',                     'uses'=>'Kcner\AdvisoryController@getAdvisory'));

    //Order Request
    Route::any('/order',                                     array('as'=>'listOrder',                       'uses'=>'Kcner\OrderController@index'));
    Route::any('/order/generateOrderTable',                  array('as'=>'generateOrderTable',              'uses'=>'Kcner\OrderController@generateOrderTable'));
    Route::any('/order/edit/{id}',                           array('as'=>'edit',                            'uses'=>'Kcner\OrderController@edit'));
    Route::any('/order/orderDetails/{id}',                   array('as'=>'orderDetails',                    'uses'=>'Kcner\OrderController@getListOrderDetail'));
    Route::get('/order/deleteOrderDetail/{id}',              array('as'=>'orderDetails',                    'uses'=>'Kcner\OrderController@deleteOrderDetail'));
    Route::post('/order/updateOrderService',                 array('as'=>'updateOrderService',              'uses'=>'Kcner\OrderController@updateOrderService'));
    Route::any('/order/getOrderDetailisOrdered',             array('as'=>'getOrderDetailisOrdered',         'uses'=>'Kcner\OrderController@getOrderDetailisOrdered'));
    Route::any('/order/checkFeeShipping',                    array('as'=>'checkFeeShipping',                'uses'=>'Kcner\OrderController@checkFeeShipping'));
    Route::any('/order/searchAddressDelivery',               array('as'=>'searchAddressDelivery',           'uses'=>'Kcner\OrderController@searchAddressDelivery'));
    Route::any('/order/createOrder',                         array('as'=>'OrderCreateOrder',                'uses'=>'Kcner\OrderController@createOrder'));
    Route::post('/order/updateOrderDetail/{orderId}/{orderDetailId}', array('as'=>'OrderUpdateOrderDetail', 'uses'=>'Kcner\OrderController@updateOrderDetail'));
    Route::post('/order/searchProduct',                      array('as'=>'OrderSearchProduct',              'uses'=>'Kcner\OrderController@searchProduct'));
    Route::get('/order/addProductToOrder',                   array('as'=>'OrderAddProductToOrder',           'uses'=>'Kcner\OrderController@addProductToOrder'));
    Route::get('/order/deleteOrderDetail',                   array('as'=>'OrderDeleteOrderDetail',           'uses'=>'Kcner\OrderController@deleteOrderDetail'));
    Route::get('/order/getWardByDistrictId',                 array('as'=>'OrderGetWardByDistrictId',         'uses'=>'Kcner\OrderController@getWardByDistrictId'));
    Route::get('/order/cancelOrder',                         array('as'=>'OrderCancelOrder',                 'uses'=>'Kcner\OrderController@cancelOrder'));
    Route::get('/order/exportProductAtStore',                array('as'=>'OrderExportProductAtStore',        'uses'=>'Kcner\OrderController@exportProductAtStore'));

    //Shipping Controller
    Route::any('/shipping',                                  array('as'=>'listShipping',                        'uses'=>'Kcner\ShippingController@index'));
    Route::any('/shipping/createShipping',                   array('as'=>'createShipping',                      'uses'=>'Kcner\ShippingController@createShipping'));
    Route::any('/shipping/generateShippingTable',            array('as'=>'generateShippingTable',               'uses'=>'Kcner\ShippingController@generateShippingTable'));
    Route::get('/shipping/detail/',                          array('as'=>'detailShipping',                      'uses'=>'Kcner\ShippingController@detail'));
    Route::get('/shipping/printOrder/',                      array('as'=>'ShippingPrintOrder',                  'uses'=>'Kcner\ShippingController@printOrder'));
    Route::get('/shipping/printOrderStore/',                 array('as'=>'ShippingPrintOrderStore',             'uses'=>'Kcner\ShippingController@printOrderStore'));

    //Partner Controller
    Route::any('/partner',                                          array('as'=>'listPartner',                              'uses'=>'Kcner\PartnerController@index'));
    Route::any('/partner/detail/{id}',                              array('as'=>'partnerDetail',                            'uses'=>'Kcner\PartnerController@detail'));
    Route::any('/partner/generateUserWaitingTransferTable',         array('as'=>'partnerGenerateUserWaitingTransferTable',  'uses'=>'Kcner\PartnerController@generateUserWaitingTransferTable'));
    Route::any('/partner/generateAllCommissionTable/{id}',          array('as'=>'partnerGenerateAllCommissionTable',        'uses'=>'Kcner\PartnerController@generateAllCommissionTable'));
    Route::any('/partner/generateTempCommissionTable/{id}',         array('as'=>'partnerGenerateTempCommissionTable',       'uses'=>'Kcner\PartnerController@generateTempCommissionTable'));
    Route::any('/partner/generateValidCommissionTable/{id}',        array('as'=>'partnerGenerateValidCommissionTable',      'uses'=>'Kcner\PartnerController@generateValidCommissionTable'));
    Route::any('/partner/generatePaymentCommissionTable/{id}',      array('as'=>'partnerGeneratePaymentCommissionTable',    'uses'=>'Kcner\PartnerController@generatePaymentCommissionTable'));
    Route::any('/partner/generatePaymentHistoryTable/{id}',         array('as'=>'partnerGeneratePaymentHistoryTable',       'uses'=>'Kcner\PartnerController@generatePaymentHistoryTable'));
    Route::any('/partner/transfer',                                 array('as'=>'partnerTransfer',                          'uses'=>'Kcner\PartnerController@transfer'));
    Route::any('/partner/historyTransfer',                          array('as'=>'partnerHistoryTransfer',                   'uses'=>'Kcner\PartnerController@historyTransfer'));
    Route::any('/partner/generatePartnerPaymentTable',              array('as'=>'partnerGeneratePartnerPaymentTable',       'uses'=>'Kcner\PartnerController@generatePartnerPaymentTable'));
    Route::any('/partner/detailTransfer/{id}',                      array('as'=>'partnerDetailTransfer',                    'uses'=>'Kcner\PartnerController@detailTransfer'));

    Route::any('/upload/chunk',                                     array('as'=>'upload',     'uses'=>'Client\UploadController@chunk'));

    // General request

    Route::any('/base/changeStatus',                                array('as'=>'Base.change.status',                       'uses'=>'Kcner\BaseController@changeStatus'));
    Route::any('/base/updateField',                                 array('as'=>'updateField',                              'uses'=>'Kcner\BaseController@updateField'));

    Route::group(['prefix'=>'chat'], function(){
        Route::any('/',                                         array('as'=>'Chat.list',                        'uses'=>'Kcner\ChatController@index'));
        Route::any('sendMessage',                               array('as'=>'Chat.send.message',                'uses'=>'Kcner\ChatController@sendMessage'));
        Route::get('getNewMessage',                             array('as'=>'Chat.get.new.message',             'uses'=>'Kcner\ChatController@getNewMessage'));
        Route::get('getOldThread',                              array('as'=>'Chat.get.old.thread',              'uses'=>'Kcner\ChatController@getOldThread'));
        Route::post('updateLastRead',                           array('as'=>'Chat.update.last.read',            'uses'=>'Kcner\ChatController@updateLastRead'));
        Route::post('getUserMessage',                           array('as'=>'Chat.get.user.message',            'uses'=>'Kcner\ChatController@getUserMessage'));
    });

    Route::group(['prefix'=>'blog'], function(){
        Route::any('/',                                         array('as'=>'Blog.list',                        'uses'=>'Kcner\BlogController@index'));
        Route::any('/relation/{typeId}',                        array('as'=>'Blog.relation.tag',                'uses'=>'Kcner\BlogController@relation'));
        Route::any('/generatePostTable',                        array('as'=>'Blog.generate.post.table',         'uses'=>'Kcner\BlogController@generatePostTable'));
        Route::any('/generateCommentTable/{postId}',            array('as'=>'Blog.generate.comment.table',      'uses'=>'Kcner\BlogController@generateCommentTable'));
        Route::any('/createNewPost',                            array('as'=>'Blog.create.new.post',             'uses'=>'Kcner\BlogController@createNewPost'));
        Route::any('/editPost/{postId}',                        array('as'=>'Blog.edit.post',                   'uses'=>'Kcner\BlogController@editPost'));
        Route::any('/searchTagPost',                            array('as'=>'Blog.search.tag.post',             'uses'=>'Kcner\BlogController@searchTagPost'));
    ...
    Route::group(['prefix'=>'campaign'], function(){
        Route::get('/',                                         array('as'=>'Campaign.index',                        'uses'=>'Kcner\CampaignController@index'));
        Route::get('/generateCampaignTable',                    array('as'=>'Campaign.list',                         'uses'=>'Kcner\CampaignController@generateCampaignTable'));
        Route::post('/createCampaign',                          array('as'=>'Campaign.createCampaign',               'uses'=>'Kcner\CampaignController@createCampaign'));
        Route::post('/validateTimeCampaign',                    array('as'=>'Campaign.validateTimeCampaign',         'uses'=>'Kcner\CampaignController@validateTimeCampaign'));
        Route::get('/edit',                                     array('as'=>'Campaign.editCampaign',                 'uses'=>'Kcner\CampaignController@edit'));
        Route::post('/edit',                                    array('as'=>'Campaign.postEditCampaign',             'uses'=>'Kcner\CampaignController@postEdit'));
        Route::post('/updateCampaignImage',                     array('as'=>'Campaign.updateCampaignImage',          'uses'=>'Kcner\CampaignController@updateCampaignImage'));
    });
