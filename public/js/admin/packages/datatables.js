...
var datatablePackage = {
    ...
    datatable: {
        ...
        generateCampaignTable: function (element, columns, addParamsCallBack, cacheLoadedCallBack) {
            var url = '/campaign/generateCampaignTable/';
            var options = {
                'order': [0, "desc"],
                displayLength: 10
            };
        ...
        generateFacebookCommentTable: function (element, columns,addParamsCallBack, cacheLoadedCallBack) {
            var url = '/user/generateFacebookCommentTable/';
            var options = {
                'order': [0, "desc"],
                displayLength: 50
            };
