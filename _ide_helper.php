 ...
 * Generated for Laravel 5.0.35 on 2017-06-01.
 *
...
namespace Illuminate\Support\Facades {
    ...
    class Queue {
        ...
        public static function pushOn($queue, $job, $data = '')
        {
            ...
            return \Illuminate\Queue\SqsQueue::pushOn($queue, $job, $data);
        }
        ...
        {
            //Method inherited from \Illuminate\Queue\Queue            
            return \Illuminate\Queue\SqsQueue::laterOn($queue, $delay, $job, $data);
        }
